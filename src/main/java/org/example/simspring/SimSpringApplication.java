...
import org.example.simspring.beans.car;
import org.example.simspring.config.AnnotationConfig;
...
//        Engine engine = ctx3.getBean(Engine.class);
        car car1 = ctx3.getBean(car.class);
        car1.carStart();
//        engine.EngineStart();
    }
